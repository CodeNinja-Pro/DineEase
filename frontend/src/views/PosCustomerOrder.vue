...
export default {
  ...
  methods: {
    ...
    getTaxesPrice: function () {
      ...
      for (var i = 0; i < this.order.length; i++) {
        value +=
          parseFloat(this.order[i].price) * parseInt(this.order[i].quantity) * 0.06;
      }
      return value.toFixed(2);
    },
                ...
                <card class="h-100">
                  <card-body class="h-100 p-1">
                    <a
                      href="#"
                      class="pos-product"
                      v-bind:class="{ 'not-available': !food.available }"
            ...
            <div class="tab-pane fade h-100 show active" id="newOrderTab">
              ...
              <div class="pos-order" v-if="order.length > 0" v-for="order in order">
                <div class="pos-order-product">
                  <div
                    class="img"
                    v-bind:style="{ backgroundImage: 'url(' + order.image + ')' }"
                  ></div>
                  <div class="flex-1">
                    <div class="h6 mb-1">{{ order.title }}</div>
                    <div class="small">${{ order.price }}</div>
                    <div class="small mb-2">
                      <div v-for="option in order.options">
                    ...
                    <div class="d-flex">
                      <a
                        ...
                        v-on:click="(event) => deductQty(event, order.id)"
                      ...
                      <a
                        href="#"
                        class="btn btn-outline-theme btn-sm"
                        v-on:click="(event) => addQty(event, order.id)"
                ...
                >
                  ...
                  <div>
                    <a
                      href="#"
                      v-on:click="(event) => toggleConfirmation(event, order.id, false)"
                      class="btn btn-outline-white btn-sm ms-auto me-2 width-100px"
                      >No</a
                    >
                    <a
                      href="#"
                      v-on:click="(event) => removeOrder(event, order.id)"
            ...
            <card-body class="p-0">
              ...
              <div class="modal-pos-product">
                <div class="modal-pos-product-img">
                  <div
                    class="img"
                    v-bind:style="{ backgroundImage: 'url(' + modalData.image + ')' }"
                  ></div>
                </div>
                <div class="modal-pos-product-info d-flex flex-column">
                  ...
                  <div class="d-flex mb-3">
                    <a
                      href="#"
                      class="btn btn-outline-theme"
                      v-on:click="(event) => deductModalQty(event)"
                      ><i class="fa fa-minus"></i
                    ></a>
                    <input
                      type="text"
                    ...
                    <a
                      href="#"
                      class="btn btn-outline-theme"
                      v-on:click="(event) => addModalQty(event)"
                      ><i class="fa fa-plus"></i
                    ></a>
                  </div>
                  <template v-if="modalData.options">
                    ...
                    <div class="mb-2" v-if="modalData.options.size">
                      ...
                      <div class="option-list">
                        <div
                          class="option"
                          v-for="(size, index) in modalData.options.size"
                        >
                          <input
                            type="radio"
                            v-bind:id="'size[' + index + ']'"
                            name="size"
                            class="option-input"
                            v-model="modalSelectedSize"
                    ...
                    <div class="mb-2" v-if="modalData.options.addon">
                      ...
                      <div class="option-list">
                        <div
                          class="option"
                          v-for="(addon, index) in modalData.options.addon"
                        >
                          <input
                            type="checkbox"
                            v-bind:name="'addon[' + index + ']'"
                            v-bind:value="addon.text"
                            v-model="modalSelectedAddon"
                            class="option-input"
                            v-bind:id="'addon[' + index + ']'"
                          />
